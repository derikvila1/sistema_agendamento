...
<div class="item">
    ...
    <div class="menu">
        <a class="item" href="/curso">
            Novo Curso
        </a>
        <a class="item" href="/curso/lista">
            Listar Cursos
        </a>
        <a class="item" href="/curso/relatorio">
            Relatorio
        </a>
        <a class="item" href="/relatorio/gerar">
...
<!-- <div class="item">
    <div class=" header">Inscrições</div>
    <div class="menu">
        <a class="item" href="/inscricao">
            Nova Inscrição
        </a>
        <a class="item" href="/inscricao/lista">
           Listar Incrições
        </a>
    </div>
</div> -->
