    ...
    <div class="" style="padding-top: 5rem ;">
        ...
        <div class="card-form">
            ...
            <div class="ui breadcrumb">
                ...
                <div class="active section">Unidade</div>
            </div>
            <br>
            ...
            <table class="ui celled table">
                ...
                <tbody>
                    ...
                    <form action="/selecionar-curso/{{$dados->unidade}}" id="{{$dados->unidade}}">
                        <tr>
                            <td class="selectable">
                                <a href="#" onclick="document.getElementById('{{$dados->unidade}}').submit()">
                                    {{$dados->unidade}}
                                </a>
                            </td>
                        </tr>
