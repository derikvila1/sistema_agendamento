    ...
    <div class="" style="padding-top: 5rem ;">
        ...
        <div class="card-form">
            ...
            <div class="ui breadcrumb">
                ...
                <span class="divider">/</span>
                <div class="active section">Nucleo</div>
            </div>
            <br>
            ...
            <table class="ui celled table">
                ...
                <tbody>
                    ...
                    <form action="/selecionar-curso/{{$unidade}}/{{$dados->nucleo}}" id="{{$dados->nucleo}}">
                        <tr>
                            <td class="selectable">
                                <a href="#" onclick="document.getElementById('{{$dados->nucleo}}').submit()">
                                    {{$dados->nucleo}}
                                </a>
                            </td>
                        </tr>
